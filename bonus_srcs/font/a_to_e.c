...
/*   Updated: 2022/08/10 22:25:28 by nguiard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_a(t_img *img, t_co co, int size)
{
	...
	straight_line(img, (t_co){.x = co.x + 5 * size, .y = co.y + 5 * size,
		.color = co.color}, 5 * size, DIR_Y);
	straight_line(img, (t_co){.x = co.x + 4 * size, .y = co.y + 2.5 * size,
...
void	ft_b(t_img *img, t_co co, int size)
{
	...
	straight_line(img, (t_co){.x = co.x + 4 * size, .y = co.y + 2.5 * size,
		.color = co.color}, 2 * size, DIR_X);
	straight_line(img, (t_co){.x = co.x + 4 * size, .y = co.y + 7.5 * size,
		.color = co.color}, 2 * size, DIR_X);
}
